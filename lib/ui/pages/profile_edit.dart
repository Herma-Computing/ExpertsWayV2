...
class _EditProfileState extends State<EditProfile> {
  ...
  getValue() async {
    ...
    await ApiProvider().profileGet();
    setState(() {
      firstName = prefs.getString('name')!;
      lastName = prefs.getString("last_name");
      dateInputController.text = prefs.getString("birthdate")!;
  ...
  Widget build(BuildContext context) {
    final text = Provider.of<ThemeProvider>(context).currentTheme == ThemeMode.dark ? 'DarkTheme' : 'LightTheme';
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text('Edit Profile', textAlign: TextAlign.end, style: textTheme.headline1?.copyWith(fontSize: 20, fontWeight: FontWeight.w500)),
                              ...
                              return Theme(
                                data: Theme.of(context).copyWith(
                                  ...
                                  dialogBackgroundColor:
                                      themeProvider.currentTheme == ThemeData.light() ? Colors.white : const Color.fromARGB(255, 25, 32, 36),
                                  colorScheme: ColorScheme.light(
                                    primary: Colors.blue, // header background color
                                    onPrimary: themeProvider.currentTheme == ThemeData.light()
                                        ? Colors.white
                                        : const Color.fromARGB(255, 25, 32, 36), // header text color
                                    onSurface: themeProvider.currentTheme == ThemeData.light() ? Colors.black : Colors.white, // body text color
                                  ),
                    ...
                    child: Theme(
                        ...
                        textTheme: TextTheme(
                          subtitle1: TextStyle(
                            ...
                            color: themeProvider.currentTheme == ThemeData.dark()
                                ? Colors.white
                                : const Color.fromARGB(255, 41, 40, 40).withOpacity(0.9),
                      ...
                      child: DropdownSearch<String>(
                        ...
                        dropdownSearchDecoration: InputDecoration(
                          hintText: "Country",
                          filled: true,
                          fillColor: themeProvider.currentTheme == ThemeData.light() ? Colors.white : const Color.fromARGB(26, 255, 255, 255),
